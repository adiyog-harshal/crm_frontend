...
const Deals = () => {
 ...
 const fetchLeads = async () => {
  try {
    ...
    console.error("========== DEAL LEADS ERROR ==========");
    console.error("URL:", error.config?.url);
    console.error("BASE URL:", error.config?.baseURL);
    console.error("FINAL URL:", error.request?.responseURL);
...
const handleAddDeal = async (e) => {
  ...
  try {
    ...
    const response = await api.post("deal/add/", payload);

    console.log("DEAL SUCCESS:", response.data);
...
const handleDealFormSubmit = (e) => {
    ...
    if (activeModal === "add") {
      const payload = {
        ...
        lead: Number(dealForm.lead),
        amount: Number(dealForm.value),
                    ...
                    >
                      ...
                      <div className="deal-card-footer">
                        <div className="deal-val-container">
                          ...
                          <span className="deal-val-amount">₹{Number(deal.value || 0).toLocaleString()}</span>
                        </div>
